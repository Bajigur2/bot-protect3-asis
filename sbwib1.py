...
helpmsg ="""
╔═════════════════
║☆☞ Č̪͙̬̤͕̲͍̽̊̂̂̑O̸̢̲̪͍͓͕̻̹͂͗̋͐͊̿͟M̨̛̩͔͚̠͖͐̉͑͛͟͜M̻͈͙̹͍̜̎̽͑͌̌̂͢͞͡Ȧ̶͔̖͕͈͓̲͙̻̎́̂̎͡N̵̨̩̞̫̙̺̼͈͌̽͒̑̈́͢͡͞͝D̷̝̝͖̙͚͙͕̼̰͓̊̉̈̒͗̈́ ☜☆
╠═════════════════
╠[➣ Oswib1
╠[➣ Oswib2
╠[➣ Oswib3
...
helpself ="""
╔═════════════════
║☆☞ Č̪͙̬̤͕̲͍̽̊̂̂̑O̸̢̲̪͍͓͕̻̹͂͗̋͐͊̿͟M̨̛̩͔͚̠͖͐̉͑͛͟͜M̻͈͙̹͍̜̎̽͑͌̌̂͢͞͡Ȧ̶͔̖͕͈͓̲͙̻̎́̂̎͡N̵̨̩̞̫̙̺̼͈͌̽͒̑̈́͢͡͞͝D̷̝̝͖̙͚͙͕̼̰͓̊̉̈̒͗̈́2̜̪̠̦̠̭̥̬̉̆̀͗͒̂͗̊̚͞ ☜☆
╠═════════════════
╠[➣ Cctv on/off
╠[➣ Intip/Ciduk
╠[➣ Setimage: (link)
...
helpset ="""
╔═════════════════
║☆☞ Č̪͙̬̤͕̲͍̽̊̂̂̑O̸̢̲̪͍͓͕̻̹͂͗̋͐͊̿͟M̨̛̩͔͚̠͖͐̉͑͛͟͜M̻͈͙̹͍̜̎̽͑͌̌̂͢͞͡Ȧ̶͔̖͕͈͓̲͙̻̎́̂̎͡N̵̨̩̞̫̙̺̼͈͌̽͒̑̈́͢͡͞͝D̷̝̝͖̙͚͙͕̼̰͓̊̉̈̒͗̈́3̶̖̲̥̠̘̉͋̒̀̉͒̍̀͢͢͟͜͜͠͠☜☆
╠═════════════════
╠[➣ Gurl
╠[➣ Grup cancel:
╠[➣ Share on/off
...
helpgrup ="""
╔═════════════════
║☆☞ Č̪͙̬̤͕̲͍̽̊̂̂̑O̸̢̲̪͍͓͕̻̹͂͗̋͐͊̿͟M̨̛̩͔͚̠͖͐̉͑͛͟͜M̻͈͙̹͍̜̎̽͑͌̌̂͢͞͡Ȧ̶͔̖͕͈͓̲͙̻̎́̂̎͡N̵̨̩̞̫̙̺̼͈͌̽͒̑̈́͢͡͞͝D̝̝͖̙͚͙͕̼̰̜̪̠̦̠̭̥̬̊̉̈̒͗̈́̉̆̀͗͒̂͗̊̚͞4̧̳͙̰̼̫̟́̃̄͋̊͘͢ ☜☆
╠═════════════════
╠[➣ Mode on/off
╠[➣ Protect on/off
╠[➣ Qr on/off
...
helprhs ="""
╔═════════════════
║☆☞ Č̪͙̬̤͕̲͍̽̊̂̂̑O̸̢̲̪͍͓͕̻̹͂͗̋͐͊̿͟M̨̛̩͔͚̠͖͐̉͑͛͟͜M̻͈͙̹͍̜̎̽͑͌̌̂͢͞͡Ȧ̶͔̖͕͈͓̲͙̻̎́̂̎͡N̵̨̩̞̫̙̺̼͈͌̽͒̑̈́͢͡͞͝D̝̝͖̙͚͙͕̼̰̜̪̠̦̠̭̥̬̊̉̈̒͗̈́̉̆̀͗͒̂͗̊̚͞5̶̧͖̖̰͕̗̳͙̰̼̫̟̏̃̾͐̓̑̾́̃̄͋̊̚̕͘͢͞ ☜☆
╠═════════════════
╠[➣ Byebye
╠[➣ Ifconfig
╠[➣ System
